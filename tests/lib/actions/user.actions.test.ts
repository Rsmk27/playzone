...
describe('user.actions', () => {
  ...
  describe('createUser', () => {
    ...
    it('should throw an error if creating a user fails and log to console', async () => {
  ...
  describe('updateUser', () => {
    ...
    it('should throw an error if the user is not found during update (returns null)', async () => {
  ...
  describe('deleteUser', () => {
    ...
    it('should throw an error if the user is not found during deletion (returns null)', async () => {
      const clerkId = 'non_existent_id';
